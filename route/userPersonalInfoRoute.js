...
router.post("/notificationByEmail", userPerInfoController.notificationByEmail);
router.post("/notificationByprofilePicture", userPerInfoController.notificationByprofilePicture);
